...
export const languagesAry = [
    ...
    "src/lib/imgs/C.png",
    "src/lib/imgs/ISO_C++_Logo.svg.png",
...
export const backendAry = [
    ...
    "src/lib/imgs/mongo.svg",
    "src/lib/imgs/Postgresql_elephant.svg.png"
]
export const frontendAry = [
    "src/lib/imgs/react.svg",
    "src/lib/imgs/1200px-Svelte_Logo.svg.png",
    "src/lib/imgs/tailwind.svg",
    "src/lib/imgs/Flutter_logo.svg.png"
]
export const toolsAry = [
    "src/lib/imgs/githublogo.png",
    "src/lib/imgs/linuxpenguin.png",
    "src/lib/imgs/swagger-icon-512x512-halz44im.png"
]
